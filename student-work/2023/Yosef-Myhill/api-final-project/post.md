...
This article displays the parameters for a POST request with a "mealCat" value of "burgerMeal". The "burgerMeal" API call allows the user to choose a meal that includes a burger, 1 or 2 side dishes, and a soft drink.
## Syntax
...
<table>
	...
	<tr>
		<td>200 - OK</td>
		<td>You meal was successfully ordered.</td>
	<tr>
